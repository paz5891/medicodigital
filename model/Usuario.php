...
Class Usuario
{
    ...
    {
    	$sql="SELECT u.idusuario,u.nombre,u.telefono,u.email,u.cargo,u.imagen,u.login, u.clave, med.idmedico, med.idmedico FROM usuario u 
		LEFT JOIN medico med on u.idusuario = med.idusuario
