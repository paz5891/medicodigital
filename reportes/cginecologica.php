...
class PDF extends FPDF {
    ...
    function Header() {
      ...
      $this->Cell( 80 );
      // Títuloutf8_decode
      $this->Cell( 35, 5, utf8_decode( 'CONSULTA GINECOLÓGICA' ), 0, 0, 'C' );
      $this->Cell( -119 );
...
$id = $_GET["id"];
$consultacinco = new Consultacinco();
$rspta = $consultacinco->datosGinecologica($id);
...
$pdf->Cell( 96, 5, utf8_decode("Peso: ".$reg->peso), 1, 0, 'L', 1 );
$pdf->Cell( 96, 5, utf8_decode("Temperatura: ".$reg->temperatura), 1, 1, 'L', 1 );


$pdf->Cell( 192, 5, utf8_decode("Fecha última regla"), 1, 1, 'C', 1 );
$pdf->MultiCell( 192, 5, utf8_decode($reg->fur), 1, 1, 'J', 1 );
...
$pdf->MultiCell( 192, 5, utf8_decode($reg->ultrasonidopelvico), 1, 1, 'J', 1 );
...
$sig = date( "d/m/Y");
$consultaginecologica ='consultaginecologica'.$sig;



//$pdf->Output();
//$pdf->Output($consultaginecologica.'.pdf','D'); 
