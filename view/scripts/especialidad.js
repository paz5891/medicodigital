        ...
        buttons: [
                  {
                   ...
                   },
                    {
                        extend: 'print',
                        text: 'IMPRIMIR',
                        title: 'Especialidades del Sistema  Clinica Génesis'
                    },
                    {
                        extend: 'pdf',
                        text: 'DESCARGAR PDF',
...
function guardaryeditar(e)
{
    ...
    $.ajax({
        url: "../controller/especialidad.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
        ...
        success: function (datos) {
            if (datos == 1) {
                ...
                Swal.fire({
                    position: 'top-end',
                    icon: 'error',
                    title: 'Especialidad no se pudo actualizar',
                    showConfirmButton: false,
                    timer: 1500
                })
            }else if (datos == 2) {
                Swal.fire({
                    position: 'top-end',
                    icon: 'error',
                    title: 'No se pudo registrar la especialidad',
                    showConfirmButton: false,
                    timer: 1500
                })
            }
...
{
	$.post("../controller/especialidad.php?op=mostrar",{idespecialidad : idespecialidad}, function(data, status)
	{
...
function desactivar(idespecialidad) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            $.post("../controller/especialidad.php?op=desactivar", {
...
function activar(idespecialidad) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.post("../controller/especialidad.php?op=activar", {
                idespecialidad: idespecialidad
            }, function (e) {
                tabla.ajax.reload();
            });
