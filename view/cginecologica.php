              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Consulta ginecológica <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        ...
                        <div class="container-fluid">
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              ...
                              <input type="hidden" name="idcginecologica" id="idcginecologica">
                          </div>
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <textarea type="text" class="form-control" name="mc" id="mc" maxlength="256" placeholder="" rows="5"></textarea>
                        </div>
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="fur" id="fur" maxlength="256" placeholder="">
                        </div>
                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <textarea type="text" class="form-control" name="examenfisico" id="examenfisico" maxlength="256" placeholder="" rows="5"></textarea>
                        </div>
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <textarea type="text" class="form-control" name="descripcionresexadiag" id="descripcionresexadiag" maxlength="256" placeholder="" rows="5"></textarea>
                        </div>
                    
                         <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <label>Ultrasonido Pélvico:</label>
                            <textarea class="form-control" name="usgpelv" id="usgpelv" maxlength="250" placeholder="Información del usg realizado por el Dr. en la consulta" rows="5"></textarea>
                        </div>
                         <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <label>Impresión Clínica:</label>
                            <textarea class="form-control" name="ic" id="ic" maxlength="250" placeholder="Impresión Clínica" rows="5"></textarea>
                        </div>
                         <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <label>Tratamiento:</label>
                            <textarea class="form-control" name="tx" id="tx" maxlength="250" placeholder="Tratamiento" rows="5"></textarea>
                        </div>
                         <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <label>Orden de examen de diagnóstico:</label>
                            <textarea class="form-control" name="ordenexadiag" id="ordenexadiag" maxlength="250" placeholder="" rows="5"></textarea>
                        </div>
                         <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            ...
                            <textarea class="form-control" name="observaciones" id="observaciones" maxlength="250" placeholder="" rows="5"></textarea>
                        </div>
...
?>
<script type="text/javascript" src="scripts/cginecologica.js"></script>
<script>
