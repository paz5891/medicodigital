              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Consulta pediátrica <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        ...
                        <div class="container-fluid">
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              ...
                              <input type="hidden" name="idcpediatrica" id="idcpediatrica">
                          </div>
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="adecuacion" id="adecuacion" maxlength="256" placeholder="">
                        </div>
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="examendental" id="examendental" maxlength="256" placeholder="">
                        </div>
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="descripcionresexadiag" id="descripcionresexadiag" maxlength="256" placeholder="">
                        </div>
...
?>
<script type="text/javascript" src="scripts/cpediatrica.js"></script>
<script>
