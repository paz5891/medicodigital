...
class PDF extends FPDF {
    ...
    function Header() {
      ...
      $this->Cell( 80 );
      // Títuloutf8_decode
      $this->Cell( 35, 5, utf8_decode( 'CONSULTA PEDIÁTRICA' ), 0, 0, 'C' );
      $this->Cell( -119 );
...
require_once "../model/Consultacuatro.php";
$id = $_GET["id"];
$consultacuatro = new Consultacuatro();
$rspta = $consultacuatro->datosPediatrica($id);
...
$pdf->Cell( 64, 5, utf8_decode("Seguro: ".$reg->seguro), 1, 0, 'L', 1 );
$pdf->Cell( 64, 5, utf8_decode("Próxima cita: ".$reg->proximacita), 1, 1, 'L', 1 );

$pdf->Cell( 64, 5, utf8_decode("Peso: ".$reg->peso), 1, 0, 'L', 1 );
$pdf->Cell( 64, 5, utf8_decode("Estatura: ".$reg->estatura), 1, 0, 'L', 1 );
$pdf->Cell( 64, 5, utf8_decode("Temperatura: ".$reg->temperatura), 1, 1, 'L', 1 );


$pdf->Cell( 64, 5, utf8_decode("Presión arterial: ".$reg->presionarterial), 1, 0, 'L', 1 );
$pdf->Cell( 64, 5, utf8_decode("Frecuencia cardíaca: ".$reg->frecuenciacardiaca), 1, 0, 'L', 1 );

$pdf->Cell( 64, 5, utf8_decode("Frecuencia respiratoria: ".$reg->frecuenciarespiratoria), 1, 1, 'L', 1 );



$pdf->SetFont( 'Arial', 'B', 9 );
$pdf->Cell( 192, 5, utf8_decode("Adecuación"), 1, 1, 'C', 1 );
$pdf->MultiCell( 192, 5, utf8_decode($reg->adecuacion), 1, 1, 'J', 1 );
$pdf->SetFont( 'Arial', 'B', 9 );
$pdf->Cell( 192, 5, utf8_decode("Examen dental"), 1, 1, 'C', 1 );
$pdf->MultiCell( 192, 5, utf8_decode($reg->examendental), 1, 1, 'J', 1 );
$pdf->SetFont( 'Arial', 'B', 9 );
$pdf->Cell( 192, 5, utf8_decode("Motivo de consulta"), 1, 1, 'C', 1 );
$pdf->MultiCell( 192, 5, utf8_decode($reg->motivoconsulta), 1, 1, 'J', 1 );
$pdf->SetFont( 'Arial', 'B', 9 );
